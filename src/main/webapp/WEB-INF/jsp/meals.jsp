    ...
    <table class="table table-striped" id="datatable" border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr id="${meal.id}" data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a><span class="fa fa-pencil"></span><spring:message code="common.update"/></a></td>
                <td><a class="delete"><span class="fa fa-remove"></span><spring:message code="common.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
